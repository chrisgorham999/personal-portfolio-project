...
class Header extends HTMLElement
{
    ...
    connectedCallback() {
        ...
        <nav class="w3-sidebar w3-bar-block gorham-small w3-hide-small w3-center">
          ...
          <a href="index.html" class="w3-bar-item w3-button gorham-padding-12 gorham-black">
          ...
          <a href="api.html" class="w3-bar-item w3-button gorham-padding-12 w3-hover-black">
          <i class="fa fa-laptop gorham-xxlarge"></i>
          <p>API UNIT TESTS</p>
          </a>
          <a href="index.html#bucket-list" class="w3-bar-item w3-button gorham-padding-12 w3-hover-black">
